					...
					>
						<View style={{ flexDirection: 'row' }}>
							<View style={{ flex: 1 }}>
								...
								<Text style={STYLES.cardDescription}>{mockBrandResult.name}</Text>
							</View>

							<View style={{ flex: 1 }}>
								<Text style={STYLES.cardHeaderTitle}>batch code</Text>
								<Text style={STYLES.cardDescription}>{mockBrandResult.batchCode}</Text>
							</View>
						</View>
						...
						<View style={{ flexDirection: 'row' }}>
							<View style={{ flex: 1 }}>
								...
								<Text style={STYLES.cardDescription}>
									{mockBrandResult.dateManufactured}
								</Text>
							</View>

							<View style={{ flex: 1 }}>
								<Text style={STYLES.cardHeaderTitle}>current age</Text>
								<Text style={STYLES.cardDescription}>{mockBrandResult.currentAge}</Text>
							</View>
						</View>
						...
						<View style={{ borderTopWidth: 1, borderTopColor: Colors.textColor + '1a' }}>
							<View style={{ paddingTop: 10 }}>
								...
								<Text style={STYLES.cardDescription}>
									{mockBrandResult.estimatedExpiration}
								</Text>
							</View>
						</View>
					</View>
